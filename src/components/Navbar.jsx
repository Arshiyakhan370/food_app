...
const Navbar = () => {
  ...
  return (
    <Fragment>
      ...
      >
        <Link to="/"><div onClick={(e)=>{e.stopPropagation();dispatch(cartAction.setShowMenu(false))}} >
        ...
        6.5zM20 21h1v-1c0-3.859-3.141-7-7-7h-4c-3.86 0-7 3.141-7 7v1h17z"></path>
         ...
         0-6-2.691-6-6h2c0 2.206 1.794 4 4 4s4-1.794 4-4h2c0 3.309-2.691 6-6 6z"></path>
          ...
          <div className={classes.burgerMenu}>
            ...
            <svg onClick={()=>dispatch(cartAction.setShowMenu(true))} viewBox="0 0 100 80" width="40" height="40">
            ...
            <li className={classes.navItem} >
              ...
              <Link to="/menu" style={{ textDecoration: "none", color: "#3D081B" }} onClick={()=>dispatch(cartAction.setShowMenu(false))}>Menu</Link>
            </li>

            <li className={classes.navItem}>
              <Link to="/faq" style={{ textDecoration: "none", color: "#3D081B" }}  onClick={()=>dispatch(cartAction.setShowMenu(false))}>FAQ</Link>
            </li>
            <li className={classes.navItem}>
              <Link to="/about" style={{ textDecoration: "none", color: "#3D081B" }}  onClick={()=>dispatch(cartAction.setShowMenu(false))}>About</Link>
            ...
            <li className={classes.navItem}>
              <Link to="/contact" style={{ textDecoration: "none", color: "#3D081B" }} onClick={()=>dispatch(cartAction.setShowMenu(false))}>Contact</Link>
            </li>
          </ul>
            </div>
          }
