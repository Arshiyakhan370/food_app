...
<h5>(416) 623-0317</h5>
<h5>chashmiyakhan@gmail.com</h5>

<h6 className={classes.timing}>Monday 10:30 a.m. - 9:00 p.m.</h6>
<h6 className={classes.timing}>Tuesday 10:30 a.m. - 9:00 p.m.</h6>
<h6 className={classes.timing}>Wednesday 10:30 a.m. - 9:00 p.m.</h6>
<h6 className={classes.timing}>Thursday 10:30 a.m. - 9:00 p.m.</h6>
<h6 className={classes.timing}>Friday 10:30 a.m. - 9:00 p.m.</h6>
<h6 className={classes.timing}>Saturday 11:00 a.m. - 9:00 p.m.</h6>
<h6 className={classes.timing}>Sunday Closed
</h6>
 ...
 <div className={classes.appContainer2}>
      ...
      <div className={classes.imageCard3}>
          <img
            ...
            className="" style={{height:"120px",width:"120px",marginTop:"15px"}}
          />
        </div>
    </div>
